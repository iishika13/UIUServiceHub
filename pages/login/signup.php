    ...
    <main class="container row m-auto justify-content-center p-4 ">
        ...
        <form class="col-5 d-flex flex-column align-items-center needs-validation"
            ...
            <div class="d-flex flex-column justify-content-center mb-2">
                ...
                <div class="input-group w-100 mb-2">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="radio" name="account-type" value="forumRep"
                            id="forum" style="
                    margin-right: 0.4rem;" required>
                        <label for="forum">Forum Representative</label>
                    </div>
                </div>

                <div class="input-group w-100">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="radio" name="account-type" value="general_user"
                            id="general" style="
                    margin-right: 0.4rem;" required>
            ...
            <div class="form-floating mb-3 w-100">
                ...
                <label for="password">Password</label>
                <div class="invalid-feedback fw-bold">
                    Password must be between 3 and 8 characters long.
                </div>
            </div>
            ...
            <div class="form-floating mb-3 w-100">
                <p class="m-0 text-center text-uppercase mb-1"> Select Gender : </p>
                <select class="form-select form-select-lg mb-3" id="gender" name="gender"
        ...
        <h5 class="mt-4 fw-bold col-10 text-center">Already have an account? <a href="../../index.php" class="ml-1">Log
                in here</a></h5>
    </main>
