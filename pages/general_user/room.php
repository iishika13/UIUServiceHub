...
$room_query = mysqli_query($sql, "select * from room1 where active = 1");
...
$joined_query = "select * from room1 r join users u on u.room_id = r.id where u.users_id = {$_SESSION["id"]} and u.approve = 1";
