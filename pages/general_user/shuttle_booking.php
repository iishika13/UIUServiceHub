...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="shuttle_service.php"><i
                                    class="fa-solid fa-bus-simple"></i> Shuttle Service</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="shuttle_booking.php"> <i
                                    class="fa-solid fa-bus"></i> Shuttle Booking</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="request_new_shuttle.php"> <i
                                    class="fa-solid fa-bus-simple"></i> Request for new Shuttle</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="print_ticket.php"> <i
                                    class="fa-solid fa-ticket"></i> Ticket</a>
                        </li>
    ...
    <div class="container-fluid container">
        <div class="row">
            <div class="col-lg-4 right22 d-none d-md-none d-lg-block">
                <img src="assets/img/bus2.png" alt="" width="100%">
            </div>

            <div class="card">
                <div class="card-header" style="text-align: center;">
                    <h3>Shuttle Booking</h3>
                </div>

                <div class="card-body">
                    <form action="payment_shuttle.php" method="POST">
                        ...
                        <div class="from-group">
                            <label for="destination">Route No</label>
                ...
                <button type="submit" class="btn btn-cus btn-block" style="margin:10px 0px 10px 0px">Book
                    Shuttle</button>
                <button onclick="location.href='shuttle_service.php';" type="button"
                    class="btn btn-cus2 btn-block">Cancel</button>
                </form>
            </div>
        </div>
    </div>
