...
//$r = "SELECT * FROM given_loan WHERE loan_id= '$pid'";
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <form action="update_bal.php" method="POST">
                                    <div class="form-group">
                                        <form action="">
                                            <label for="username">
                                                <h2 style="margin-bottom: 5%;">Remaining Loan: ৳ <?php// echo $amount ?></h2>
                                                <h6>BKash Number</h6>
                                            </label>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button onclick="location.href = 'loan.php';" type="button" class="w-100 subscribe btn btn-cus2 btn-block shadow-sm"> Cancel Payment & Return Home</button>
                                </form>
