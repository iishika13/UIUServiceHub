                    ...
                    <div class="card-header">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <form action="C_shuttle_booking.php" method="POST">
                                    <div class="form-group">
                                        <form action="">
                                            <label for="username">
                                                <h2 style="margin-bottom: 5%;">Payment Amount : 1500৳  <?php// echo $amount ?></h2>
                                                <h6>BKash Number</h6>
                                            </label>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button onclick="location.href = 'shuttle_service.php';" type="button" class="w-100 subscribe btn btn-cus2 btn-block shadow-sm"> Cancel Payment & Return Home</button>
                                </form>
                        ...
                        <div id="paypal" class="tab-pane fade">
                            ...
                            <form action="update_bal.php" method="POST">
                                    <div class="form-group">
                                        <form action="">
                                            <label for="username">
                                                <h2 style="margin-bottom: 5%;">Payment Amount : 1500৳ <?php //echo $amount ?></h2>
