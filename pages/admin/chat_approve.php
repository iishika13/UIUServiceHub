    ...
    <div class="container main">
        <div class="conteiner">
            <div style="text-align: center;">
                ...
                <div id="left">
                    <?php 
                        $r1  = "SELECT * FROM `room1` WHERE active = 0;";
                    ...
                    {
                        ?>
                                <div class="list" draggable="true" data-room-id="<?php echo $row['id']; ?>"><img
                                        src="assets/imgs/i.png"><?php echo $row['forum_name']?></div>
                                <?php
                    } 
                            }
            ...
            <div style="text-align: center;">
                ...
                <div id="right">
                    <?php 
                        $r1  = "SELECT * FROM `room1` WHERE active = 1;";
                        $result = mysqli_query($sql, $r1);
                        if (mysqli_num_rows($result) > 0)
                            {
                                while($row = mysqli_fetch_assoc($result))
