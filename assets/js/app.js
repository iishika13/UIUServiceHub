...
var captcha_section = document.getElementById("type-captcha");
...
admin_box.addEventListener("click", () => {
    if (admin_box.checked) {
        ...
        captcha_section.style.marginTop = "100px";
        ...
        // Reset margin-top of captcha section
        captcha_section.style.marginTop = ""; // Reset to default
    }
});
